      ...
      <v-app :theme="theme">
        <v-app-bar scroll-behavior="elevate">
          ...
          <template v-slot:append>
            <v-btn :icon="showAnswer === true ? 'mdi-eye-outline' : 'mdi-eye-off-outline'" @click="showAnswer = !showAnswer"></v-btn>
        ...
        <v-date-picker v-model="date" :allowed-dates="allowedDates" :min="allowedDates[0]" :max="allowedDates[allowedDates.length-1]"></v-date-picker>
        ...
        questions: [
          {
            ...
            links: [{link: 'https://en.wikipedia.org/wiki/Hydrogen', metadata: {
              name: "Wikipedia",
            }}],
            hints: [
